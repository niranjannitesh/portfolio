  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="21-year-old hacker. I design things, I build things, sometimes I break things and then I put them back together. Building things from scratch for a while now."
        />
        <meta
          name="twitter:title"
          content="Nitesh Kumar Niranjan — Product Designer / Developer"
        />
        <meta
